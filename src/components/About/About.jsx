  ...
  return (
    <div className="lg:py-24 md:py-24 sm:py-12 lg:px-10 md:px-10 px-8">
      ...
      <div className="lg:max-w-5xl mx-auto pt-8">
        <div className="pt-8">
          <h2 className="text-2xl text-brand dark:text-brand-dark font-bold pb-3">My Skills</h2>
        ...
        <div className="pt-8">
          <h2 className="text-2xl text-brand dark:text-brand-dark font-bold pb-3">Projects</h2>
        ...
        <div className="pt-8">
          <h2 className="text-2xl text-brand dark:text-brand-dark font-bold pb-3">Goals</h2>
