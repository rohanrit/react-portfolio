  ...
  return (
    <div className="lg:py-24 md:py-24 sm:py-12 lg:px-10 md:px-10 px-8">
      ...
      <div className="lg:max-w-5xl mx-auto pt-8">
        <div className="pt-8">
          <h1 className="text-2xl text-white font-bold pb-3">My <span className='text-brand dark:text-brand-dark'>Skills</span> </h1>
        ...
        <div className="pt-8">
          <h1 className="text-2xl text-brand dark:text-brand-dark font-bold pb-3">Projects</h1>
        ...
        <div className="pt-8">
          <h1 className="text-2xl text-brand dark:text-brand-dark font-bold pb-3">Goals</h1>
